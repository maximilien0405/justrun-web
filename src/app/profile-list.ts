...
export const PROFILE: Profile[] = [
    ...
    },*/
    {
      ...
      group: "game-level-design",
      presentationFR: "Vivre un univers : c'est bien, mais créer un univers : c'est beaucoup mieux !",
      presentationEN: "Living a universe: that's good, but creating a universe: that's much better!",
